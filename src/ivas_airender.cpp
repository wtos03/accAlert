...
//Show accident text
void show_status (gpointer kpriv_ptr,bool acc_status)
{    
...
extern "C"
{
      ...
      IVASFrame * input[MAX_NUM_OBJECT], IVASFrame * output[MAX_NUM_OBJECT])
  {
    ...
    fps_overlay(kpriv);
    // ---------------- invtos
    save_object(CHK_ACCIDENT,0,0,0,0); //End of frame, checking crash conditions
    show_status (kpriv,get_set_accident_status(GET_VALUE,0));
    // ---------------- 
    return 0;
  }
